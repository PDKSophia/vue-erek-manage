<template>
  <div :style="{height: '100%'}">
    <Layout :style="{height: '100%'}">
      <Sider
        hide-trigger
        :style="{ background: theme.bgVueErek, width: '240px', minWidth: '240px', maxWidth: '240px', height: '100%' }"
      >
        <Menu
          :active-name="Menu[0].name"
          :style="{ background: theme.bgVueErek, color: `${theme.colorVueErek} !important` }"
        >
